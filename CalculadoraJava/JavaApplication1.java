...
public class JavaApplication1 {
    public static void main(String[] args) {
        ...
        System.out.println("---Menu principal---"); // imprimir menu
        ...
        double resultado = 0; // establecer variable en 0 para usar
        if (opcion == 1) {
            resultado = a + b; //sumar
        }else if (opcion == 2) {
            resultado = a - b; //restar
        }else if (opcion == 3) {
            resultado = a * b; //multiplicacion
        }else if (opcion == 4) {
            if (b == 0) {      //si divide en 0 devuelve 0
                resultado = 0;
            }else {
                resultado = a / b; //si no devuelve division
            }
        }else {
